    ...
    <body>
        ...
        <div class="row h-100">
            ...
            <div class="col-md mt-4">
                    <h5 class="well">Excluir Cargo</h5>
                    
                    <form class="form-horizontal" action="delete-cargo.php" method="post">
                        <input type="hidden" name="id" value="<?php echo $id;?>" />
                        <div class="alert alert-danger"> Deseja excluir o Cargo?
                        </div>
                        <div class="form actions">
                            <button type="submit" class="btn btn-danger">Sim</button>
                            <a href="cargos.php" type="btn" class="btn btn-outline-danger">Não</a>
                        </div>
                    </form>
                </div>
            </div>
