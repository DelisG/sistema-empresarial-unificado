    ...
    <div class="container-fluid h-100">
        <div class="row h-100">
            <div class="col-lg-3 col-md-4 bg-dark">
                <a href="index.php">
                    <h5 class="text-light text-center py-4">Sistema Empresarial Unificado</h5>
                </a>
                <div class="d-flex flex-column my-3">
                    <a href="index.php" class="mb-3 btn btn-dark text-left"><i
                            class="fa-solid fa-house-chimney mr-2"></i>Inicio</a>
                    <a href="funcionarios.php" class="mb-3 btn btn-dark text-left"><i
                            class="fa-solid fa-user-group mr-2"></i>Listar Funcionários</button></a>
                    <a href="create-funcionario.php" class="mb-3 btn btn-dark text-left"><i
                            class="fa-solid fa-user-plus mr-2"></i>Adicionar Funcionário</button></a>
                    <a href="cargos.php" class="mb-3 btn btn-dark text-left"><i class="fa-solid fa-file mr-2"></i>Listar
                        Cargos</button></a>
                    <a href="create-cargo.php" class="mb-3 btn btn-dark text-left"><i
                            class="fa-solid fa-file-circle-plus mr-2"></i>Adicionar Cargo</button></a>
                </div>
            </div>
                ...
                <div class="card-body">
                    <form class="row" action="update-funcionario.php?id=<?php echo $id ?>" method="post">
                        ...
                        <div class="col-sm-6 control-group <?php echo !empty($nomeErro) ? 'error' : ''; ?>">
                            ...
                            <div class="controls">
                                <input name="sobrenome" class="form-control" size="50" type="text"
                                    placeholder="sobreNome" value="<?php echo !empty($sobrenome) ? $sobrenome : ''; ?>">
                                <?php if (!empty($sobrenomeErro)): ?>
                                    <span class="text-danger">
                                        <?php echo $sobrenomeErro; ?>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
